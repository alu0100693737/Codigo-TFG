...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{CDetectarLineas_8h__incl}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{CDetectarLineas_8h__dep__incl}
\end{center}
\end{figure}
\subsection*{Classes}
...
\begin{DoxyCompactList}\small\item\em Clase para la deteccion de Lineas Valor por defecto para la deteccion, hough\+LinesP 80. \end{DoxyCompactList}\end{DoxyCompactItemize}
\subsection*{Macros}
\begin{DoxyCompactItemize}
\item 
