...
\index{C\+Asistente\+Codificacion@{C\+Asistente\+Codificacion}!C\+Asistente\+Codificacion@{C\+Asistente\+Codificacion}}
\subsubsection[{\texorpdfstring{C\+Asistente\+Codificacion(int nodos, string inicial, string finales, vector$<$ int $>$ $\ast$ini, vector$<$ int $>$ $\ast$fins, vector$<$ char $>$ $\ast$let, Q\+Widget $\ast$parent=0)}{CAsistenteCodificacion(int nodos, string inicial, string finales, vector< int > *ini, vector< int > *fins, vector< char > *let, QWidget *parent=0)}}]{\setlength{\rightskip}{0pt plus 5cm}C\+Asistente\+Codificacion\+::\+C\+Asistente\+Codificacion (
...
)}\hypertarget{classCAsistenteCodificacion_a8648c998d92db260247f676e29a02a40}{}\label{classCAsistenteCodificacion_a8648c998d92db260247f676e29a02a40}
...
{\em nodos.} & Numero de nodos del automata \\
\hline
{\em inicial.} & Nodo inicial del automata \\
\hline
{\em finales.} & Nodos finales del automata \\
\hline
{\em ini.} & Conjunto de inicios de transiciones \\
\hline
{\em fins} & Conjunto de destinos de transiciones \\
\hline
{\em let} & Conjunto de letras entre transiciones \\
\hline
{\em parent} & Ventana padre \\
\hline
\end{DoxyParams}
...
Metodo que devuelve el Q\+Line\+Edit con los automatas a añadir. Estos se introducen por Ventana. 
...
Metodo que devuelve el \hyperlink{classCPushButton}{C\+Push\+Button} Cancelar automata. 

\begin{DoxyReturn}{Returns}
\hyperlink{classCPushButton}{C\+Push\+Button} 
\end{DoxyReturn}
...
Metodo que devuelve el vector de \hyperlink{classCCheckBox}{C\+Check\+Box} Borrar. 

\begin{DoxyReturn}{Returns}
vector$<$\+C\+Check\+Box$\ast$$>$$\ast$ 
\end{DoxyReturn}
...
Metodo que devuelve el vector de \hyperlink{classCCheckBox}{C\+Check\+Box} Cambiar. 

\begin{DoxyReturn}{Returns}
vector$<$\+C\+Check\+Box$\ast$$>$$\ast$ 
\end{DoxyReturn}
\index{C\+Asistente\+Codificacion@{C\+Asistente\+Codificacion}!get\+Corregir\+Automata@{get\+Corregir\+Automata}}
\index{get\+Corregir\+Automata@{get\+Corregir\+Automata}!C\+Asistente\+Codificacion@{C\+Asistente\+Codificacion}}
\subsubsection[{\texorpdfstring{get\+Corregir\+Automata()}{getCorregirAutomata()}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf C\+Push\+Button} $\ast$ C\+Asistente\+Codificacion\+::get\+Corregir\+Automata (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}\hypertarget{classCAsistenteCodificacion_a4c1bda55c2989b2d231a7280e017f4b4}{}\label{classCAsistenteCodificacion_a4c1bda55c2989b2d231a7280e017f4b4}


Metodo que devuelve el \hyperlink{classCPushButton}{C\+Push\+Button} Corregir Automata sobre el asistente. 
...
Metodo que devuelve el vector de \hyperlink{classCLineEdit}{C\+Line\+Edit} Destinos Cambiar. 

\begin{DoxyReturn}{Returns}
vector$<$\+C\+Line\+Edit$\ast$$>$$\ast$ 
\end{DoxyReturn}
\index{C\+Asistente\+Codificacion@{C\+Asistente\+Codificacion}!get\+Guardar\+Como\+Fichero@{get\+Guardar\+Como\+Fichero}}
\index{get\+Guardar\+Como\+Fichero@{get\+Guardar\+Como\+Fichero}!C\+Asistente\+Codificacion@{C\+Asistente\+Codificacion}}
\subsubsection[{\texorpdfstring{get\+Guardar\+Como\+Fichero()}{getGuardarComoFichero()}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf C\+Push\+Button} $\ast$ C\+Asistente\+Codificacion\+::get\+Guardar\+Como\+Fichero (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}\hypertarget{classCAsistenteCodificacion_add7a4598c4e7099600d86679af61c138}{}\label{classCAsistenteCodificacion_add7a4598c4e7099600d86679af61c138}


Metodo que devuelve el \hyperlink{classCPushButton}{C\+Push\+Button} Aceptar automata. 
...
Metodo que devuelve el \hyperlink{classCPushButton}{C\+Push\+Button} Ayuda sobre el asistente. 
...
Metodo que devuelve el vector de \hyperlink{classCLineEdit}{C\+Line\+Edit} Inicios. 
...
Metodo que devuelve el \hyperlink{classCLabel}{C\+Label} con el texto \textquotesingle{}Añadir\textquotesingle{}. 
...
Metodo que devuelve el \hyperlink{classCLabel}{C\+Label} con el texto \textquotesingle{}Borrar\textquotesingle{}. 
...
Metodo que devuelve el \hyperlink{classCLabel}{C\+Label} con el texto \textquotesingle{}Cambiar\textquotesingle{}. 
...
Metodo que devuelve el \hyperlink{classCLabel}{C\+Label} con el texto \textquotesingle{}Destino\textquotesingle{}. 
...
Metodo que devuelve el vector de \hyperlink{classCLineEdit}{C\+Line\+Edit} Letras. 
...
Metodo que devuelve el \hyperlink{classCLabel}{C\+Label} con el texto \textquotesingle{}Inicio\textquotesingle{}. 
...
Metodo que devuelve el \hyperlink{classCLabel}{C\+Label} con el texto \textquotesingle{}Letra\textquotesingle{}. 
...
int 
\end{DoxyReturn}
\index{C\+Asistente\+Codificacion@{C\+Asistente\+Codificacion}!guardar\+Automata\+Temporal@{guardar\+Automata\+Temporal}}
\index{guardar\+Automata\+Temporal@{guardar\+Automata\+Temporal}!C\+Asistente\+Codificacion@{C\+Asistente\+Codificacion}}
\subsubsection[{\texorpdfstring{guardar\+Automata\+Temporal()}{guardarAutomataTemporal()}}]{\setlength{\rightskip}{0pt plus 5cm}void C\+Asistente\+Codificacion\+::guardar\+Automata\+Temporal (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}\hypertarget{classCAsistenteCodificacion_afcefa5d9f23cfe6cad585cfeb1d31d37}{}\label{classCAsistenteCodificacion_afcefa5d9f23cfe6cad585cfeb1d31d37}
...
Metodo Slot que cambia los valores de inicio y destino de la fila correspondiente si el valor del checkbox de esa linea esta marcado. 
...
\index{C\+Asistente\+Codificacion@{C\+Asistente\+Codificacion}!slot\+Corregir\+Automata@{slot\+Corregir\+Automata}}
\index{slot\+Corregir\+Automata@{slot\+Corregir\+Automata}!C\+Asistente\+Codificacion@{C\+Asistente\+Codificacion}}
\subsubsection[{\texorpdfstring{slot\+Corregir\+Automata}{slotCorregirAutomata}}]{\setlength{\rightskip}{0pt plus 5cm}void C\+Asistente\+Codificacion\+::slot\+Corregir\+Automata (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [slot]}}\hypertarget{classCAsistenteCodificacion_a3a5f81fcdc2f4531d56d788dc521c798}{}\label{classCAsistenteCodificacion_a3a5f81fcdc2f4531d56d788dc521c798}


Metodo Slot que lanza la accion corregir automata. 

\index{C\+Asistente\+Codificacion@{C\+Asistente\+Codificacion}!slot\+Guardar\+Como\+Fichero@{slot\+Guardar\+Como\+Fichero}}
\index{slot\+Guardar\+Como\+Fichero@{slot\+Guardar\+Como\+Fichero}!C\+Asistente\+Codificacion@{C\+Asistente\+Codificacion}}
\subsubsection[{\texorpdfstring{slot\+Guardar\+Como\+Fichero}{slotGuardarComoFichero}}]{\setlength{\rightskip}{0pt plus 5cm}void C\+Asistente\+Codificacion\+::slot\+Guardar\+Como\+Fichero (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [slot]}}\hypertarget{classCAsistenteCodificacion_aeddb96e8728045fe121c2365e4a94cb5}{}\label{classCAsistenteCodificacion_aeddb96e8728045fe121c2365e4a94cb5}
...
Crea una nueva ventana con la codificacion deseada por si se desea consultar \index{C\+Asistente\+Codificacion@{C\+Asistente\+Codificacion}!slot\+Help@{slot\+Help}}
...
Crea una ventana que tenga la imagen info\+Asistente con informacion relevante \index{C\+Asistente\+Codificacion@{C\+Asistente\+Codificacion}!ventana\+Info\+Codificacion@{ventana\+Info\+Codificacion}}
...
ventana\+Info\+Codificacion Metodo que crea una ventana Q\+Widget con la informacion resultado de la codificacion 
...
Q\+Line\+Edit para añadir nuevas transiciones si se desea. 
...
\index{C\+Asistente\+Codificacion@{C\+Asistente\+Codificacion}!corregir\+Automata\+\_\+@{corregir\+Automata\+\_\+}}
\index{corregir\+Automata\+\_\+@{corregir\+Automata\+\_\+}!C\+Asistente\+Codificacion@{C\+Asistente\+Codificacion}}
\subsubsection[{\texorpdfstring{corregir\+Automata\+\_\+}{corregirAutomata_}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf C\+Push\+Button}$\ast$ C\+Asistente\+Codificacion\+::corregir\+Automata\+\_\+\hspace{0.3cm}{\ttfamily [private]}}\hypertarget{classCAsistenteCodificacion_afd75aaa033b9e2147f82bdb64db6fecf}{}\label{classCAsistenteCodificacion_afd75aaa033b9e2147f82bdb64db6fecf}


\hyperlink{classCPushButton}{C\+Push\+Button} para cancelar la codificacion del automata. 
...
\index{C\+Asistente\+Codificacion@{C\+Asistente\+Codificacion}!guardar\+Como\+Fichero\+\_\+@{guardar\+Como\+Fichero\+\_\+}}
\index{guardar\+Como\+Fichero\+\_\+@{guardar\+Como\+Fichero\+\_\+}!C\+Asistente\+Codificacion@{C\+Asistente\+Codificacion}}
\subsubsection[{\texorpdfstring{guardar\+Como\+Fichero\+\_\+}{guardarComoFichero_}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf C\+Push\+Button}$\ast$ C\+Asistente\+Codificacion\+::guardar\+Como\+Fichero\+\_\+\hspace{0.3cm}{\ttfamily [private]}}\hypertarget{classCAsistenteCodificacion_a898ca68d14748bb8bd7d4694e80d3da8}{}\label{classCAsistenteCodificacion_a898ca68d14748bb8bd7d4694e80d3da8}
